    ...
    if command == "check_processors":
            ...
            if 'event-convert' in ep:
                ...
                if 'transforms' in ec:
                    for transform in ec['transforms']:
                        if 'replace' in transform and 'old' in transform['replace']:
                            if transform['replace']['old'] == pattern:
                                print("true")
                                sys.exit(0)
        print("false")
        ...
        for ep in processor['event-processors']:
            if 'event-convert' in ep:
                ...
                if 'transforms' in ec:
                    for transform in ec['transforms']:
                        if 'replace' in transform and 'new' in transform['replace']:
                            if transform['replace']['new'] == new_name:
                                print("true")
                                sys.exit(0)
        print("false")
