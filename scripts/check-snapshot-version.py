...
def main():
    parser = argparse.ArgumentParser(description="Check version compatibility of state snapshots")
    parser.add_argument("snapshots", nargs="+", help="Snapshot file(s) to check")
    parser.add_argument("-v", "--verbose", action="store_true", help="Print detailed information")
    parser.add_argument(
        "--fail-on-upgrade", action="store_true", help="Exit with error if snapshot needs upgrade"
    )
