...
- [~] 15. Implement gNMIc metric normalization processors
  ...
  - [-] 15.2 Configure Arista metric normalization
  ...
  - [ ] 15.3 Configure SONiC metric normalization
  ...
  - [ ] 15.4 Configure Juniper metric normalization
...
- [~] 16. Implement Prometheus relabeling rules
  - [ ] 16.1 Add interface name normalization rules
  ...
  - [ ] 16.2 Add vendor-specific relabeling rules
    - Preserve vendor label from gNMIc
    - Add device role labels (spine, leaf)
    - Add topology labels
    - _Requirements: 4.2_
  
  - [ ] 16.3 Implement transformation rule validation
...
- [ ] 40. Implement property-based tests
...
- [ ] 41. Implement unit tests
  - [ ] 41.1 Create deployment unit tests
  ...
  - [ ] 41.2 Create configuration unit tests
  ...
  - [ ] 41.3 Create telemetry unit tests
  ...
  - [ ] 41.4 Create validation unit tests
  ...
  - [ ] 41.5 Create state management unit tests
...
- [ ] 42. Implement integration tests
  - [ ] 42.1 Create end-to-end workflow tests
  ...
  - [ ] 42.2 Create multi-vendor integration tests
  ...
  - [ ] 42.3 Create monitoring stack integration tests
