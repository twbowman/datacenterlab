...
class TestGNMISubscriptions:
    ...
    def test_openconfig_bgp_subscription(self, mock_gnmi_connection):
        ...
        subscription = {
            "name": "oc_bgp_state",
            "paths": ["/network-instances/network-instance/protocols/protocol/bgp/neighbors"],
            "mode": "stream",
    ...
    def test_subscription_encoding_options(self):
        ...
        subscription = {"name": "test_sub", "paths": ["/test"], "encoding": "json_ietf"}
...
class TestMetricNormalization:
    ...
    def test_vendor_label_addition(self):
        ...
        metric = {
            "name": "network_interface_in_octets",
            "labels": {"source": "spine1", "vendor": "nokia", "interface": "ethernet-1/1"},
        }
    ...
    def test_interface_name_normalization(self):
        ...
        for _vendor, normalized in normalized_names.items():
    ...
    def test_native_metric_vendor_prefix(self):
        ...
        native_metric = {
            ...
            "labels": {"vendor": "nokia", "metric_type": "native"},
        }
...
class TestPrometheusExport:
    ...
    def test_prometheus_label_format(self):
        ...
        labels = {"source": "spine1", "vendor": "nokia", "interface": "eth1_1", "role": "spine"}
...
class TestTelemetryProcessors:
    ...
    def test_event_convert_processor(self):
        ...
        processor = {
            "event-convert": {
                "value-names": ["^/srl_nokia/interface/statistics/in-octets$"],
                "transforms": [
                    {
                        "replace": {
                            "apply-on": "name",
    ...
    def test_event_add_tag_processor(self):
        ...
        processor = {"event-add-tag": {"tags": {"vendor": "nokia", "os": "srlinux"}}}
    ...
    def test_processor_chain_order(self):
        ...
        processor_chain = ["normalize_metrics", "add_vendor_labels", "format_for_prometheus"]
...
class TestTelemetryConnectionManagement:
    ...
    def test_connection_timeout_configuration(self, mock_gnmi_connection):
        ...
        # Mock gNMI connection is available but not used in this test
        # This ensures no actual network calls are made
        target_config = {"address": "172.20.20.10:57400", "timeout": "30s", "retry-interval": "10s"}
    ...
    def test_exponential_backoff_configuration(self, mock_gnmi_connection):
        ...
        # Mock gNMI connection is available but not used in this test
        # This ensures no actual network calls are made
        backoff_config = {"initial-interval": "1s", "max-interval": "60s", "multiplier": 2.0}
...
class TestMetricValidation:
    ...
    def test_metric_has_required_fields(self):
        ...
        metric = {
            ...
            "value": 1234567890,
            "timestamp": 1705315800,
            "labels": {"source": "spine1", "interface": "eth1_1"},
        }
