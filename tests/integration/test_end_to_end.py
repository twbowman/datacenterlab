...
class TestEndToEndWorkflow:
    ...
    def test_deploy_configure_validate_monitor_srlinux(self, orb_prefix, lab_deployed, monitoring_deployed, prometheus_url):
        """
    ...
    def test_monitoring_dashboard_queries(self, monitoring_deployed, prometheus_url, wait_for_prometheus):
        """
